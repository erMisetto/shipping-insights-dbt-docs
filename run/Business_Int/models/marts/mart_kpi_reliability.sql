        ...
        create or replace transient table BUSINESS_INT_DBT.PUBLIC_marts.mart_kpi_reliability
         as
        (select * from (
...
select * from kpi
      ...
      alter  table BUSINESS_INT_DBT.PUBLIC_marts.mart_kpi_reliability cluster by (snapshot_month);
