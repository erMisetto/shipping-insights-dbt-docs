        ...
        create or replace transient table BUSINESS_INT_DBT.PUBLIC_core.fct_leg_core
         as
        (select * from (
...
from src
      ...
      alter  table BUSINESS_INT_DBT.PUBLIC_core.fct_leg_core cluster by (departure_port_code, leg_departure_date);
